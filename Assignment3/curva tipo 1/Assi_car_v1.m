...
numEpisodes = 4e5; % number of episodes to mean
epsilon = 0.3;
alpha = 1e-2;
...
while true
    ...
    if norm(newpolicy-policy,inf) <= 6 % corrisponde al numero di elementi -> azioni che cambiamo alla policy nella singola iterazione rispetto alla policy prima
        policy= newpolicy;
        policy2=nnewpolicy;
        break;
    else
...
axis equal
save Assi_car_v1.mat policy policy2
