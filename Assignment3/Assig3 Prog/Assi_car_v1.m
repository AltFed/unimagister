...
numEpisodes = 2e4; % number of episodes to mean
epsilon = 0.5;
alpha = 1e-2;
...
while true
    ...
    if norm(newpolicy-policy,inf) <= 5 % corrisponde al numero di elementi -> azioni che cambiamo alla policy nella singola iterazione rispetto alla policy prima
        policy= newpolicy;
        policy2=nnewpolicy;
        break;
    else
